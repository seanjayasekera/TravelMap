...
<div class="topbar">
  ...
  <div class="sub">Track trips, meals, and costs</div>
</div>
...
# Always use background.jpg (no uploader in UI)
bg_bytes = None
bg_found = False
...
/* Do not override headings globally (keeps white text in topbar) */
</style>
""", unsafe_allow_html=True)
...
# =========================
st.markdown("---")
st.markdown("🌍 Thanks for exploring the Travel Dashboard!", unsafe_allow_html=True)