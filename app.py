...
/* Add safe top padding across builds */
...
with tab_add_trip:
    ...
    with st.form("form_add_trip", clear_on_submit=True):
        ...
        # Side-by-side: Meal total & Activities
    ...
    if submitted:
        if not trip_name or not primary_city or not country or start_date is None or end_date is None:
            ...
            new_row = {
                ...
                "food_cost_usd": float(meal_cost_total_usd),   # manual total meal cost
            }
